                ...
                <form action="{{ route('user.usaha.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <label for="nama_usaha" class="block text-sm font-bold text-gray-700 mb-1">Nama Usaha <span
                        ...
                        <!-- Kategori -->
                        <div>
                            <label for="kategori_id" class="block text-sm font-bold text-gray-700 mb-1">Kategori Usaha <span
                                    class="text-red-500">*</span></label>
                            <select id="kategori_id" name="kategori_id"
                                class="w-full rounded-lg bg-white border-2 border-gray-200 text-gray-900 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all px-4 py-2.5 text-base @error('kategori_id') border-red-500 focus:border-red-500 @enderror"
                                required>
                        ...
                        <!-- Kelurahan -->
                        <div>
                            <label for="kelurahan_id" class="block text-sm font-bold text-gray-700 mb-1">Kelurahan <span
                                    class="text-red-500">*</span></label>
                            <select id="kelurahan_id" name="kelurahan_id"
                                class="w-full rounded-lg bg-white border-2 border-gray-200 text-gray-900 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all px-4 py-2.5 text-base @error('kelurahan_id') border-red-500 focus:border-red-500 @enderror"
                                required>
                        ...
                        {{-- alamat --}}
                        <div class="md:col-span-2">
                            <label for="alamat" class="block text-sm font-bold text-gray-700 mb-1">Alamat Lengkap <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="alamat" name="alamat" value="{{ old('alamat') }}"
                                placeholder="Masukkan alamat lengkap usaha Anda"
                                class="w-full rounded-lg bg-white border-2 border-gray-200 text-gray-900 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all px-4 py-2.5 text-base @error('alamat') border-red-500 focus:border-red-500 focus:ring-red-200 @enderror"
                                required>
                            @error('alamat')
                                <p class="mt-1.5 text-xs font-semibold text-red-600 flex items-center gap-1">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                        ...
                        <!-- Deskripsi Usaha -->
                        <div class="md:col-span-2">
                            <label for="deskripsi" class="block text-sm font-bold text-gray-700 mb-1">Deskripsi
                                Usaha</label>
                            <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Ceritakan tentang usaha Anda..."
                                class="w-full rounded-lg bg-white border-2 border-gray-200 text-gray-900 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all px-4 py-2.5 text-base @error('deskripsi') border-red-500 focus:border-red-500 focus:ring-red-200 @enderror">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1.5 text-xs font-semibold text-red-600 flex items-center gap-1">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                                </p>
                        ...
                        <!-- Foto Usaha -->
                        <div>
                            <label for="foto_usaha" class="block text-sm font-bold text-gray-700 mb-1">
                                Foto Usaha
                            </label>

                            <div
                                class="relative border-2 border-dashed border-gray-300 rounded-lg hover:border-indigo-500 transition-colors p-2">

                                <input type="file" id="foto_usaha" name="foto_usaha"
                                    class="w-full h-full absolute inset-0 opacity-0 cursor-pointer z-10" accept="image/*">
                                ...
                                <!-- Preview Image -->
                                <img id="foto-preview" class="hidden w-full h-48 object-cover rounded-lg"
                    ...
                    <div class="mt-8">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Lokasi Usaha <span
                                class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            ...
                            <div class="md:col-span-3">
                                <div id="map"
                                    class="w-full h-80 rounded-xl border-2 border-gray-200 shadow-inner focus-within:border-indigo-500 transition-colors z-0">
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-1 flex flex-col gap-3">
                                ...
                                <div>
                                    <label for="latitude"
                                        class="text-xs font-semibold text-gray-500 uppercase mb-1 block">Latitude</label>
                                ...
                                <div>
                                    <label for="longitude"
                                        class="text-xs font-semibold text-gray-500 uppercase mb-1 block">Longitude</label>
                    ...
                    <div class="mt-8">
                        ...
                        <div id="dokumen-container" class="space-y-4">
                            <!-- Initial Row -->
                            <div
                                class="dokumen-row grid grid-cols-1 md:grid-cols-12 gap-3 items-start p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="md:col-span-3">
                                    <label class="text-xs font-bold text-gray-500 mb-1 block">Jenis Dokumen</label>
                                    <select name="jenis_dokumen[]"
                                        class="w-full rounded-lg border-2 border-gray-200 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none px-3 py-2 bg-white">
                        ...
                        <button type="button"
                            class="mt-3 inline-flex items-center gap-2 px-4 py-2 border border-indigo-200 text-indigo-700 bg-white hover:bg-indigo-50 rounded-lg text-sm font-medium transition-colors w-full md:w-auto"
                            id="add-dokumen">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row justify-between gap-4">
                        <a href="{{ route('user.usaha.index') }}"
                            class="inline-flex justify-center items-center px-6 py-2.5 border border-gray-300 text-sm font-bold rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none transition-colors">
...
@push('scripts')
    <script>
        ...
        const map = L.map('map').setView([-2.976007, 104.778718], 12);
        ...
        document.getElementById('add-dokumen').addEventListener('click', function() {
            ...
            newRow.className =
                'dokumen-row grid grid-cols-1 md:grid-cols-12 gap-3 items-start p-4 bg-gray-50 rounded-lg border border-gray-200 relative';
            newRow.innerHTML = `
            <div class="md:col-span-3">
                <label class="text-xs font-bold text-gray-500 mb-1 block">Jenis Dokumen</label>
        ...
        document.getElementById('dokumen-container').addEventListener('click', function(e) {
            ...
            const fotoInput = document.getElementById('foto_usaha');
