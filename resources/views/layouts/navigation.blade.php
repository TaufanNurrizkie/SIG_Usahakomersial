...
@auth
    @if (auth()->user()->hasRole('admin'))
        ...
        {{-- Usaha Terdaftar --}}
        <a href="{{ route('admin.usaha.daftar') }}"
            class="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-sidebar-hover
          border-l-4 border-transparent hover:border-indigo-500 transition-all rounded-r-lg
          {{ request()->routeIs('admin.usaha.daftar') ? 'text-white bg-sidebar-hover border-indigo-500' : '' }}">
        ...
        <a href="{{ route('admin.usaha.index') }}"
            class="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-sidebar-hover
          border-l-4 border-transparent hover:border-indigo-500 transition-all rounded-r-lg
          {{ request()->routeIs('admin.usaha.index') ? 'text-white bg-sidebar-hover border-indigo-500' : '' }}">
            <i class="bi bi-shop text-lg"></i>
