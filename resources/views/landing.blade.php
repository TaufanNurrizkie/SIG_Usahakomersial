...
<body
                ...
                <div class="hidden lg:flex flex-1 justify-end gap-9 items-center">
                    <nav class="flex items-center gap-9">
                        <a class="text-[#111418] dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors"
                            href="#">Beranda</a>
                        <a class="text-[#111418] dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors"
                            href="#peta">Peta Usaha</a>
                        <a class="text-[#111418] dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors"
                            href="#stats">Statistik</a>
                        <a class="text-[#111418] dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors"
                            href="#faq">Tentang</a>
                    </nav>
    ...
    <main class="flex flex-col items-center">
                ...
                <div class="flex flex-col-reverse lg:flex-row gap-10 lg:gap-16 items-center">
                    <div class="flex flex-col gap-6 flex-1 text-left">
                        <div class="flex flex-col gap-4">
                            <div
                                class="inline-flex w-fit items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-primary text-xs font-bold uppercase tracking-wider">
                                <span class="material-symbols-outlined text-sm">verified</span>
                                Resmi Pemerintah Kecamatan
                            </div>
                            <h1
                                class="text-[#111418] dark:text-white text-4xl lg:text-5xl font-black leading-tight tracking-[-0.033em]">
                            ...
                            <h2 class="text-[#637588] dark:text-gray-400 text-lg font-normal leading-relaxed max-w-xl">
                                Layanan digital pendataan & perizinan usaha terpadu di Kertapati, Palembang. Ajukan izin
                                dan pantau perkembangan usaha Anda secara online.
                            </h2>
                        </div>
                        <div class="flex flex-wrap gap-3">
                            <a href="{{ route('user.dashboard') }}"
                                class="flex min-w-[140px] cursor-pointer items-center justify-center rounded-lg h-12 px-6 bg-primary text-white text-base font-bold shadow-lg shadow-blue-500/20 hover:bg-primary/90 hover:shadow-xl transition-all">
                                <span class="truncate">Ajukan Usaha</span>
                            </a>
                            <a href="#peta"
                                class="flex min-w-[140px] cursor-pointer items-center justify-center rounded-lg h-12 px-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-[#111418] dark:text-white text-base font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
                    ...
                    <div class="w-full lg:w-1/2">
                        <div class="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                            ...
                            <div
                                class="absolute bottom-6 left-6 right-6 p-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md rounded-xl shadow-lg z-20 border border-white/50 dark:border-gray-700/50">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="p-2 bg-green-100 dark:bg-green-900 rounded-lg text-green-600 dark:text-green-400">
                                        <span class="material-symbols-outlined">trending_up</span>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 font-semibold uppercase">
                                            Pertumbuhan UMKM</p>
                                        <p class="text-sm font-bold text-gray-900 dark:text-white">+12% di Kecamatan
                                            Kertapati Tahun Ini</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Stats Section -->
        <section id="stats"
            class="w-full bg-[#f8f9fa] dark:bg-gray-900 border-y border-gray-100 dark:border-gray-800">
            <div class="max-w-[1280px] mx-auto px-4 sm:px-10 py-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">

                    <!-- Total Usaha -->
                    <div
                        class="flex flex-col gap-1 p-5 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors">
        ...
        <section id="peta" class="w-full max-w-[1280px] px-4 sm:px-10 py-16">
            <div class="flex flex-col gap-4 mb-8">
                <h3 class="text-[#111418] dark:text-white text-2xl lg:text-3xl font-bold leading-tight">Peta Sebaran
                    Usaha</h3>
                <p class="text-gray-600 dark:text-gray-400 max-w-2xl">Pantau lokasi usaha, zonasi komersial, dan data
                    UMKM di seluruh kelurahan Kecamatan Kertapati.</p>
            </div>

            <div
                class="w-full rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div
                        class="w-full lg:w-1/3 p-8 flex flex-col justify-center gap-6 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700">
                        <div>
                        ...
                        <a href="/peta"
                            class="flex items-center justify-center gap-2 rounded-lg h-12 w-full bg-primary text-white font-bold hover:bg-primary/90 transition-colors shadow-lg shadow-blue-500/20">
        ...
        <!-- Tabel Usaha Section -->
        <section class="w-full max-w-[1280px] px-4 sm:px-10 py-16">
            <div class="flex flex-col gap-4 mb-8">
                <h3 class="text-[#111418] dark:text-white text-2xl lg:text-3xl font-bold leading-tight">Daftar Usaha
                    Terdaftar</h3>
                <p class="text-gray-600 dark:text-gray-400 max-w-2xl">Daftar lengkap usaha yang telah disetujui dan
                    terdaftar resmi di Kecamatan Kertapati.</p>
            </div>

            <div
                class="w-full rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <!-- Search & Filter Bar -->
                <div class="p-6 border-b border-gray-200 dark:border-gray-700 flex flex-col md:flex-row gap-4">
                    <div class="flex-1">
                        <div class="relative">
                            <span
                                class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">search</span>
                            <input type="text" id="searchUsaha" placeholder="Cari nama usaha..."
                                class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent">
                        </div>
                    </div>
                    <select id="filterKategori"
                        class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('usaha.show', $usaha['id']) }}"
                                            class="inline-flex items-center gap-1 text-primary hover:underline text-sm font-semibold">
                                            Lihat
                                        </a>
                ...
                <!-- Pagination -->
                <div
                    class="p-6 border-t border-gray-200 dark:border-gray-700 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="text-sm text-gray-600 dark:text-gray-400">
                        Menampilkan <span id="showingStart">0</span> - <span id="showingEnd">0</span> dari <span
                            id="totalData">0</span> usaha
                    </div>
        ...
        <section class="w-full max-w-[1280px] px-4 sm:px-10 py-16 lg:py-24">
            <div class="text-center mb-12 max-w-2xl mx-auto">
                <span class="text-primary font-bold text-sm tracking-widest uppercase mb-2 block">Alur
                    Pendaftaran</span>
                <h3 class="text-[#111418] dark:text-white text-3xl font-bold mb-4">6 Langkah Mudah Mendaftarkan Usaha
                </h3>
                <p class="text-gray-600 dark:text-gray-400">Ikuti panduan langkah demi langkah ini untuk mendapatkan
                    izin usaha resmi di Kecamatan Kertapati.</p>
            </div>
            <div class="relative">
                <div
                    class="hidden lg:block absolute top-1/2 left-0 w-full h-1 bg-gray-200 dark:bg-gray-700 -translate-y-1/2 z-0 rounded-full">
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 relative z-10">
                    <div class="flex flex-col items-center text-center group">
                        <div
                            class="w-16 h-16 rounded-full bg-white dark:bg-gray-800 border-4 border-blue-100 dark:border-gray-700 flex items-center justify-center text-primary mb-4 shadow-md group-hover:border-primary transition-colors">
                    ...
                    <div class="flex flex-col items-center text-center group">
                        <div
                            class="w-16 h-16 rounded-full bg-primary border-4 border-blue-200 dark:border-blue-900 flex items-center justify-center text-white mb-4 shadow-lg shadow-blue-500/30">
        ...
        <!-- FAQ & Requirements -->
        <section id="faq"
            class="w-full bg-white dark:bg-gray-800 py-16 border-t border-gray-100 dark:border-gray-700">
            <div class="max-w-[1280px] mx-auto px-4 sm:px-10">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-6">Sebelum mengajukan permohonan, pastikan Anda
                            telah menyiapkan dokumen berikut dalam format digital (PDF/JPG).</p>
                        <ul class="space-y-4">
                            <li class="flex items-start gap-3 p-4 rounded-lg bg-[#f8f9fa] dark:bg-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Scan KTP asli dan kartu NPWP
                            ...
                            <li class="flex items-start gap-3 p-4 rounded-lg bg-[#f8f9fa] dark:bg-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Foto tampak depan dan dalam
                                        tempat usaha.</p>
                                </div>
                            </li>
                            <li class="flex items-start gap-3 p-4 rounded-lg bg-[#f8f9fa] dark:bg-gray-700/50">
                                <span class="material-symbols-outlined text-green-500 mt-0.5">check_circle</span>
                                <div>
                                    <h6 class="font-bold text-sm text-gray-900 dark:text-white">Surat Keterangan
                                        Domisili</h6>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Dari Kelurahan setempat (jika
                                        diperlukan).</p>
                                </div>
                            </li>
                        </ul>
                        <div class="mt-8 p-4 border-l-4 border-primary bg-blue-50 dark:bg-blue-900/10">
                            <p class="text-sm text-gray-700 dark:text-gray-300">
                                <strong>Dasar Hukum:</strong> Peraturan Daerah Kota Palembang No. X Tahun 20XX tentang
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <details class="group" open>
                                <summary
                                    class="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 dark:bg-gray-700 p-4 text-gray-900 dark:text-white">
                                    <h2 class="font-bold">Berapa lama proses verifikasi?</h2>
                                    <span
                                        class="material-symbols-outlined transition duration-300 group-open:-rotate-180">expand_more</span>
                                </summary>
                                <p class="mt-4 px-4 leading-relaxed text-gray-700 dark:text-gray-300">
                                    Proses verifikasi data biasanya memakan waktu 3-5 hari kerja setelah dokumen lengkap
                            ...
                            <details class="group">
                                ...
                                <p class="mt-4 px-4 leading-relaxed text-gray-700 dark:text-gray-300">
                                    Pendaftaran melalui Sistem Pemetaan Usaha Kertapati tidak dipungut biaya (Gratis).
                                    Biaya retribusi hanya berlaku sesuai peraturan daerah untuk jenis izin tertentu.
                                </p>
                            </details>
                            <details class="group">
                                <summary
                                ...
                                <p class="mt-4 px-4 leading-relaxed text-gray-700 dark:text-gray-300">
                                    Jika data ditolak, Anda akan menerima notifikasi beserta alasannya. Anda dapat
                                    memperbaiki data dan mengunggah ulang dokumen melalui dashboard pengguna.
                                </p>
                            </details>
                        </div>
                    </div>
        ...
        <section class="w-full bg-primary py-16 relative overflow-hidden">
            ...
            <div class="relative max-w-4xl mx-auto px-4 text-center">
                <h2 class="text-3xl md:text-5xl font-black text-white mb-6 tracking-tight">Siap Mengembangkan Usaha
                    Anda?</h2>
                <p class="text-lg text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Bergabunglah sekarang untuk mendaftarkan usaha Anda agar terdata secara resmi, mudah ditemukan, dan
                    mendukung pembangunan ekonomi wilayah.
                </p>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="#"
                        class="w-full sm:w-auto px-8 py-4 text-base font-bold text-slate-900 bg-white rounded-xl hover:bg-slate-50 transition-colors shadow-xl shadow-white/10 hover:shadow-2xl hover:shadow-white/20">
                        Daftar Sekarang
                    </a>
                    <a href="#peta"
                        class="w-full sm:w-auto px-8 py-4 text-base font-bold text-white border border-white/20 rounded-xl hover:bg-white/10 transition-colors">
                        Lihat Peta Sebaran
                    </a>
                </div>
            </div>
        ...
        <footer class="w-full bg-[#111418] text-white pt-16 pb-8">
            <div class="max-w-[1280px] mx-auto px-4 sm:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                    <div>
                        ...
                        <div class="flex gap-4">
                            <a class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors"
                                href="#">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-sm text-gray-400">
                            ...
                            <li><a class="hover:text-primary transition-colors" href="#">Cek Status Izin</a>
                            </li>
                            <li><a class="hover:text-primary transition-colors" href="#stats">Statistik Wilayah</a>
                            </li>
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">© {{ date('Y') }} Kecamatan Kertapati. All rights reserved.
                    </p>
    ...
    <script>
        ...
        function applyFilter() {
            ...
            const kelurahan = kelurahanFilter.value;

            filteredData = allUsahas.filter(u => {
                const matchSearch = u.nama_usaha.toLowerCase().includes(search);
                const matchKategori = kategori ? u.kategori === kategori : true;
                const matchKelurahan = kelurahan ? u.kelurahan === kelurahan : true;

                return matchSearch && matchKategori && matchKelurahan;
            });
        ...
        function renderTable() {
            ...
            pageData.forEach((u, i) => {
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 font-semibold">${u.nama_usaha}</td>
                    <td class="px-6 py-4">${u.kategori}</td>
                    <td class="px-6 py-4">${u.kelurahan}</td>
                    <td class="px-6 py-4">${u.alamat}</td>
                    <td class="px-6 py-4">
                        <a href="/usaha/${u.id}" class="text-primary font-semibold">
                            Lihat
                        </a>
                    </td>
                </tr>
        ...
        function updateInfo() {
            document.getElementById('showingStart').innerText =
                filteredData.length ? (currentPage - 1) * rowsPerPage + 1 : 0;
            document.getElementById('showingEnd').innerText =
        ...
        kelurahanFilter.addEventListener('change', applyFilter);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Inisialisasi peta
            const kertapatiBounds = L.latLngBounds(
                [-3.030, 104.720],
                [-2.940, 104.830]
            );
            ...
            const map = L.map('kertapati-map', {
                zoomControl: false,
                maxBounds: kertapatiBounds,
                maxBoundsViscosity: 1.0 // bikin peta "mantul" & ga bisa kabur
            }).fitBounds(kertapatiBounds);
            ...
            function getIconForCategory(cat) {
                ...
                if (n.includes('kuliner') || n.includes('makan')) return {
                    icon: 'restaurant',
                    color: '#ef4444'
                };
                if (n.includes('dagang') || n.includes('toko')) return {
                    icon: 'shopping_bag',
                    color: '#3b82f6'
                };
                if (n.includes('jasa')) return {
                    icon: 'build',
                    color: '#eab308'
                };
                if (n.includes('umkm') || n.includes('industri')) return {
                    icon: 'storefront',
                    color: '#22c55e'
                };
                return {
            ...
            usahas.forEach(biz => {
                const {
                    icon,
                    color
                } = getIconForCategory(biz.kategori);
